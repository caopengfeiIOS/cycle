...
/**
 *  @author 张天浩, 16-03-09 15:03
 *
 *  @brief 生成类似  6222 **** **** 5462 格式的银行卡展示格式
 */
+ (NSString*)CreatEntryText:(NSString*)Datastr{
    
    NSString *prentStr = [Datastr substringToIndex:4];
    NSString *lastStr = [Datastr substringFromIndex:Datastr.length-4];
    
    return [NSString stringWithFormat:@"%@ **** **** %@",prentStr,lastStr];
